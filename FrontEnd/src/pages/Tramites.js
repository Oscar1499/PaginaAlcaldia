  ...
  const tramites = {
    ...
    'Trámites Empresariales': [
      { 
        ...
        costo: '$6.06',
        tiempoEspera: '1 día hábil',
        requisitos: 'Estar inscrito en el sistema de Registro Tributario Municipal y estar solvente de todas las propiedades.',
        documentacionRequerida: 'Copia de DUI y escritura de la propiedad.',
        pasosASeguir: '1. Solicitar solvencia. 2. Validar pagos. 3. Emitir vialidad o solvencia.',
        horarioAtencion: 'Lunes a Viernes 8 AM - 4 PM',
      ...
      { 
        ...
        costo: '$21.81',
        tiempoEspera: '1 día hábil',
        requisitos: ' 1. Dependen de la inspección que se le realice al usuario, en la unidad de Fiscalización, en tal caso este recibiendo servicios la propiedad, se le prescribirá en el plazo de tres años, con facultad en el Art. 62 ley general tributaria municipal.  2. Estas solvente con todas las propiedades.',
        documentacionRequerida: 'Copia de Escritura, DUI.',
        pasosASeguir: '1. Presentar copia de DUI, escritura en atención al usuario. 2. Esperar indicaciones.',
        horarioAtencion: 'Lunes a Viernes 8 AM - 4 PM',
    ...
    'Trámites de Construcción': [
      ...
      { 
        ...
        costo: '$34.65',
        tiempoEspera: '2 días hábiles',
        requisitos: 'Número del título de perpetuidad.',
        documentacionRequerida: 'Fotocopia del DUI.',
        pasosASeguir: '1. Entregar fotocopia del DUI y número del título de perpetuidad en la unidad de cementerio. 2. Validación de datos. 3. Emitir reposición.',
        horarioAtencion: 'Lunes a Viernes 8 AM - 4 PM',
        icono: 'fa-solid fa-cross' 
      },
      { 
        ...
        costo: '$8.46',
        tiempoEspera: '4 días hábiles',
        requisitos: 'Fotocopia del DUI del fallecido.',
        documentacionRequerida: 'Fotocopia del DUI del tramitante.',
        pasosASeguir: '1. Presentar ambas fotocopias de DUI en la unidad de cementerio . 2. Validación de datos. 3. Emitir certificación.',
        horarioAtencion: 'Lunes a Viernes 8 AM - 4 PM',
      ...
      { 
        ...
        costo: 'Según presupuesto de remodelación',
        tiempoEspera: '2 días hábiles',
        requisitos: 'Título de perpetuidad.',
        documentacionRequerida: 'Fotocopia del DUI.',
        pasosASeguir: '1. Presentar solicitud. 2. Entregar fotocopia del DUI y número del título de perpetuidad en la unidad de cementerio. 3. Aprobación del permiso. 4. Inicio de remodelación.',
        horarioAtencion: 'Lunes a Viernes 8 AM - 4 PM',
        icono: 'fa-solid fa-tools' 
      },
      { 
        ...
        tiempoEspera: '2 días hábiles',
        requisitos: 'Título de perpetuidad.',
        documentacionRequerida: 'Entregar fotocopia del DUI en la unidad de cementerio.',
        pasosASeguir: '1. Presentar identificación. 2. Evaluación técnica. 3. Aprobación de construcción.',
        horarioAtencion: 'Lunes a Viernes 8 AM - 4 PM',
      ...
      { 
        ...
        costo: '$47.94',
        tiempoEspera: '1 dia habil',
        requisitos: 'Título de perpetuidad .',
        documentacionRequerida: 'Copia de identificación DUI.',
      ...
      { 
        ...
        costo: '$15.75',
        tiempoEspera: '2 días hábiles',
        requisitos: 'Título de perpetuidad, autorización de la familia.',
        documentacionRequerida: 'Número del título de perpetuidad y último recibo de pago.',
      ...
      { 
        ...
        costo: '$21.06',
        tiempoEspera: '1 día hábil',
        requisitos: 'Autorización familiar, permiso del cementerio, titulo de perpetuidad',
        documentacionRequerida: 'Fotocopia del DUI.',
        pasosASeguir: '1. Presentar solicitud. 2. Entregar fotocopia del DUI y número del título de perpetuidad en la unidad de cementerio. 3. Programar apertura/cierre.',
        horarioAtencion: 'Lunes a Viernes 8 AM - 4 PM',
      ...
      { 
        ...
        costo: '$26.82',
        tiempoEspera: '2 días hábiles',
        requisitos: 'Título de perpetuidad, partida de defunción, autorización del ministerio de salud, título de perpetuidad de destino de la osamenta.',
        documentacionRequerida: 'Fotocopias de DUI del tramitante y del fallecido.',
        pasosASeguir: '1. Presentar solicitud. 2. Entregar toda la documentación en la unidad de cementerio. 3. Programar extracción y traslado.',
        horarioAtencion: 'Lunes a Viernes 8 AM - 4 PM',
      ...
      { 
        ...
        tiempoEspera: '3 días hábiles',
        requisitos: 'Título de perpetuidad.',
        documentacionRequerida: 'Copia del título de perpetuidad.',
      ...
      { 
        ...
        tiempoEspera: '2 días hábiles',
        requisitos: 'Título de perpetuidad.',
        documentacionRequerida: 'Entregar fotocopia del DUI y número del título de perpetuidad .',
        pasosASeguir: '1. Aprobación del permiso.',
        horarioAtencion: 'Lunes a Viernes 8 AM - 4 PM',
